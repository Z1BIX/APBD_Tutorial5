...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
                                .Join(emps, e => e.Mgr, m => m.EmpNo, (e, m) => new {Employee = e.EName, Manager = m.EName})
                                .ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(e => new {e.EName, Total = e.Sal + (e.Comm.HasValue ? e.Comm : 0)}).ToList(); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
                        ...
                        .SelectMany(joined => grades
                            ...
                            .Select(s => new {joined.e.EName, joined.d.DName, s.Grade}))
                        .ToList(); 
